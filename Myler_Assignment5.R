####Software Tools (BINF*6210) Assignment 5####

#Erika Myler - last updated Dec. 18, 2021
...
#Paired-end reads (2x300bp) were generated using the Illumina MiSeq instrument by Winand et al. (2020). The raw 16S10_V8_V9 and 16S10_V8_V9_NTC fastq.gz files were downloaded from the NCBI Sequence Read Archive (SRA) BioProject PRJNA587452 at:
